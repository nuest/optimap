...
class GeoextentExtractTest(TestCase):
    ...
    def setUp(self):
        ...
        self.fixtures_dir = os.path.join(os.path.dirname(__file__), "fixtures", "geoextent")
...
class GeoextentBatchTest(TestCase):
    ...
    def test_batch_multiple_files_combined(self):
        ...
        response = self.client.post(
            ...
            {"files": files, "bbox": "true", "tbox": "true", "response_format": "geojson"},
        )
...
class GeoextentRemoteTest(TestCase):
    ...
    def test_remote_single_identifier(self):
        ...
        response = self.client.post(
            ...
            json.dumps({"identifiers": [identifier], "bbox": True, "tbox": True, "response_format": "geojson"}),
    ...
    def test_remote_multiple_identifiers(self):
        ...
        response = self.client.post(
            "/api/v1/geoextent/extract-remote/",
            json.dumps({"identifiers": identifiers, "bbox": True, "tbox": True, "response_format": "geojson"}),
            content_type="application/json",
        )
    ...
    def test_remote_wkt_format(self):
        ...
        response = self.client.post(
            "/api/v1/geoextent/extract-remote/",
            json.dumps({"identifiers": [identifier], "bbox": True, "tbox": True, "response_format": "wkt"}),
            content_type="application/json",
        )
    ...
    def test_remote_single_identifier_simple_response(self):
        ...
        response = self.client.post(
            "/api/v1/geoextent/extract-remote/",
            json.dumps({"identifiers": [identifier], "bbox": True}),
            content_type="application/json",
        )
...
class GeoextentRemoteGetTest(TestCase):
    ...
    def test_get_single_identifier(self):
        ...
        response = self.client.get(
            "/api/v1/geoextent/extract-remote/",
            {"identifiers": identifier, "bbox": "true", "tbox": "true", "response_format": "geojson"},
        )
    ...
    def test_get_multiple_identifiers(self):
        ...
        response = self.client.get(
            "/api/v1/geoextent/extract-remote/",
            {"identifiers": identifiers, "bbox": "true", "tbox": "true", "response_format": "geojson"},
        )
    ...
    def test_get_geojson_format(self):
        ...
        response = self.client.get(
            "/api/v1/geoextent/extract-remote/",
            {"identifiers": identifier, "bbox": "true", "response_format": "geojson"},
        )
    ...
    def test_get_wkt_format(self):
        ...
        response = self.client.get(
            "/api/v1/geoextent/extract-remote/", {"identifiers": identifier, "bbox": "true", "response_format": "wkt"}
        )
    ...
    def test_get_missing_identifiers(self):
        ...
        response = self.client.get("/api/v1/geoextent/extract-remote/", {"bbox": "true"})
...
class GeoextentErrorHandlingTest(TestCase):
    ...
    def test_extract_no_file(self):
        ...
        response = self.client.post("/api/v1/geoextent/extract/", {"bbox": "true"})

        self.assertEqual(response.status_code, 400)

    def test_batch_no_files(self):
        """Test batch endpoint with no files provided"""
        response = self.client.post("/api/v1/geoextent/extract-batch/", {"bbox": "true"})
    ...
    def test_remote_empty_identifiers(self):
        ...
        response = self.client.post(
            "/api/v1/geoextent/extract-remote/",
            json.dumps({"identifiers": [], "bbox": True}),
            content_type="application/json",
        )
    ...
    def test_extract_invalid_format(self):
        ...
        fixtures_dir = os.path.join(os.path.dirname(__file__), "fixtures", "geoextent")
