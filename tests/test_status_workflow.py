...
from works.models import STATUS_CHOICES, Source, Work
...
class StatusWorkflowComplianceTests(TestCase):
    ...
    def test_harvested_status_visibility(self):
        ...
        pub = Work.objects.create(
            title="Harvested Publication", status="h", doi="10.1234/harvested", source=self.source
        )
    ...
    def test_draft_status_visibility(self):
        ...
        pub = Work.objects.create(title="Draft Publication", status="d", doi="10.1234/draft", source=self.source)
    ...
    def test_testing_status_visibility(self):
        ...
        pub = Work.objects.create(title="Testing Publication", status="t", doi="10.1234/testing", source=self.source)
    ...
    def test_withdrawn_status_visibility(self):
        ...
        pub = Work.objects.create(
            title="Withdrawn Publication", status="w", doi="10.1234/withdrawn", source=self.source
        )
    ...
    def test_contribution_only_allowed_for_harvested(self):
        ...
        for status_code, status_name in [("d", "Draft"), ("p", "Published"), ("t", "Testing"), ("w", "Withdrawn")]:
            pub = Work.objects.create(
