...
class BaseCachedGeoFeed(Feed):
    ...
    def _extract_authors_from_item(self, item):
        ...
        # Fallback: Try OpenAlex match info (for older publications)
...
class GlobalGeoFeed(BaseCachedGeoFeed):
    """Global feed containing all published publications."""
    ...
    def title(self):
        ...
        return f"OPTIMAP - Latest Publications ({variant})"
    ...
    def description(self):
        ...
        return "Latest research publications with geographic data from OPTIMAP."
...
class RegionalGeoFeed(BaseCachedGeoFeed):
    ...
    def title(self, obj):
        ...
        return f"OPTIMAP - {obj.name} ({region_type}) - Latest Publications ({variant})"
    ...
    def description(self, obj):
        ...
        region_type = obj.get_region_type_display()
        return (
            f"Latest research publications with geographic data from {obj.name} "
    ...
    def items(self, obj):
        ...
        logger.debug(
            "Region feed '%s': %d candidates, %d after intersection",
            obj.name, candidates.count(), len(filtered)
        )
