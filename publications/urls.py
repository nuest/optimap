...
urlpatterns = [
    ...
    path('api/schema/ui/',
         SpectacularRedocView.as_view(url_name='optimap:schema'), name='redoc'),
    path('download/geojson/', views.download_geojson, name='download_geojson'),
    path('download/geopackage/', views.download_geopackage,
         name='download_geopackage'),
    path('favicon.ico', lambda request: redirect(
        'static/favicon.ico', permanent=True)),
    ...
    path("api", lambda request: redirect(
        '/api/v1/', permanent=False), name="api"),
    ...
    path("confirm-delete/<str:token>/",
         views.confirm_account_deletion, name="confirm_delete"),
    path("confirm-email/<str:token>/<str:email_new>/",
         views.confirm_email_change, name="confirm-email-change"),
