# Generated by Django 5.1.9 on 2025-10-17 17:47
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        blank=True, related_name="publications_users", to="auth.group"
                    ),
                ),
                (
                    "user_permissions",
                    models.ManyToManyField(
                        blank=True,
                        related_name="publications_users_permissions",
                        to="auth.permission",
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="publications.harvestingevent",
                    ),
                ),
                (
                    "updated_by",
            ...
            options={
                ...
                "constraints": [
                    models.UniqueConstraint(
                        fields=("doi", "url"), name="unique_publication_entry"
                    )
                ],
            },
        ),
