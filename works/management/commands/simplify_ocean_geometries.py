...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            "--tolerance", type=float, default=0.05, help="Tolerance for geometry simplification (default: 0.1)"
        )
        parser.add_argument(
            "--preserve-topology",
            action="store_true",
    ...
    def handle(self, *args, **options):
        ...
        if not all_hole_areas:
            ...
            self.stdout.write(
                f"This will remove approximately {threshold_index + 1} holes and preserve {total_holes - threshold_index - 1} holes\n"
            )
        ...
        for i, feat in enumerate(layer):
            ...
            feature = {"type": "Feature", "geometry": mapping(simplified_geom), "properties": properties}
